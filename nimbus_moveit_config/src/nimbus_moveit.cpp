    ...
    moveToJointPoseServer(pnh, "move_to_joint_pose", boost::bind(&NimbusMoveIt::moveToJointPose, this, _1), false)
{
  ...
  followJointTrajectoryResultSubscriber = n.subscribe("/hlpr_trajectory_controller/trajectory/result", 1, &NimbusMoveIt::followJointTrajectoryResultCallback, this);

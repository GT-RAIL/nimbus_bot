...
private:
  ...
  static const int NUM_JACO_JOINTS = 7;
  static const int MAX_MOVE_ATTEMPTS = 3;

  /**
   * \brief Store updated joint states
   *
   * Subscriber to keep track of the current joint state for the robot.
   *
   * @param msg Incoming joint state information.
   */
